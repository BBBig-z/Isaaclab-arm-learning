...
# 添加参数
parser = argparse.ArgumentParser(description="Train ARM-T Lift with RSL-RL and WandB")
parser.add_argument("--video", action="store_true", default=False, help="Record videos during training.")
parser.add_argument("--video_length", type=int, default=200, help="Length of the recorded video (in steps).")
parser.add_argument("--video_interval", type=int, default=2000, help="Interval between video recordings (in steps).")
parser.add_argument("--num_envs", type=int, default=None, help="Number of environments to simulate.")
parser.add_argument("--task", type=str, default="ARM-T-Lift-Cube-v0", help="Name of the task.")
parser.add_argument("--seed", type=int, default=None, help="Seed used for the environment")
parser.add_argument("--max_iterations", type=int, default=None, help="RL Policy training iterations.")
parser.add_argument("--wandb_project", type=str, default="arm_t_lift_rsl_rl", help="WandB project name")
parser.add_argument("--wandb_entity", type=str, default=None, help="WandB entity (username/team)")
parser.add_argument("--config", type=str, default="/home/y/works/rl/isaac_so_arm101/source/ARM/arm_t/tasks/lift/agents/config_rsl_rl_ppo_lift.yaml", help="Config YAML file")
# 添加AppLauncher参数
...
def main():
    ...
    agent_cfg.experiment_name = "arm_t_lift"
